...
export default function Process() {
  return (
    <section id="process" className="section-padding bg-[#050505] border-y border-[#161616]">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {phases.map((phase) => (
            <div key={phase.step} className="gradient-border p-6 md:p-7 card-hover">
              <div className="flex items-center justify-between mb-6">
                <span className="text-[#e36d00] text-sm font-medium tracking-[0.18em]">{phase.step}</span>
                <span className="px-3 py-1 rounded-full border border-[#2a2a2a] text-xs text-[#8a8a8a]">
                  {phase.metric}
                </span>
              </div>
              ...
              <div className="rounded-[20px] border border-[#232323] bg-[#0b0b0b] p-4 mb-6">
                ...
                <div className="space-y-3">
                  <div className="h-3 rounded-full bg-[#161616] w-3/4" />
                  <div className="grid grid-cols-3 gap-3">
                    <div className="h-20 rounded-2xl border border-[#202020] bg-[linear-gradient(180deg,#131313,#0d0d0d)]" />
                    <div className="h-20 rounded-2xl border border-[#202020] bg-[linear-gradient(180deg,#151515,#101010)]" />
                    <div className="h-20 rounded-2xl border border-[#202020] bg-[linear-gradient(180deg,#1a120d,#100d0b)] ring-1 ring-[#e36d00]/15" />
                  </div>
                  <div className="h-24 rounded-2xl border border-[#202020] bg-[radial-gradient(circle_at_top,rgba(227,109,0,0.14),transparent_40%),#101010]" />
                </div>
              </div>

              <ul className="space-y-3">
                {phase.bullets.map((bullet) => (
                  <li key={bullet} className="flex items-center gap-3 text-sm text-[#b8b8b8]">
